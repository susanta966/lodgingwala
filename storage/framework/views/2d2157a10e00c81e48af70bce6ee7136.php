...
<div class="sticky-icon">
    <?php if($sitedetails->instagram): ?>
        <a href="<?php echo e($sitedetails->instagram); ?>" class="Instagram" target="_blank">
            <i class="fa-brands fa-instagram"></i> Instagram
        </a>
    <?php endif; ?>
    <?php if($sitedetails->facebook): ?>
        <a href="<?php echo e($sitedetails->facebook); ?>" class="Facebook" target="_blank">
            <i class="fa-brands fa-facebook-f"></i> Facebook
        </a>
    <?php endif; ?>
    <?php if($sitedetails->twitter): ?>
        <a href="<?php echo e($sitedetails->twitter); ?>" class="Twitter" target="_blank">
            <i class="fa-brands fa-x-twitter"></i> Twitter
        </a>
    <?php endif; ?>
    <?php if($sitedetails->whatsapp): ?>
        <a href="https://wa.me/<?php echo e($sitedetails->whatsapp); ?>" class="whatsapp" target="_blank">
            <i class="fa-brands fa-whatsapp"></i> Whatsapp
        </a>
    <?php endif; ?>
    <!--  <?php if($sitedetails->phone): ?>
<a href="tel:<?php echo e($sitedetails->phone); ?>" class="call">
            ...
            <div class="row justify-content-between">
                <div class="col-lg-4 col-md-4 col-sm-6" data-aos="fade-up" data-aos-duration="1500">
                    <div class="main-title-2">
                        <img width="250" src="<?php echo e(asset('admin/siteImage/ftlogo/' . $sitedetails->ftlogo)); ?>"
                            alt="">
                    </div>
                    <p><?php echo e($sitedetails->site_about); ?></p>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12" data-aos="fade-up" data-aos-duration="1500">
                    <div class="footer-item">
                        ...
                        <ul class="links">
                            ...
                            <li>
                                <a href="<?php echo e(route('frontend.room')); ?>">Rooms</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('frontend.blog')); ?>">Blog</a>
                            </li>
                            <!--                            <li>
                                <a href="<?php echo e(route('frontend.review')); ?>">Review Us</a>
                            </li>-->
                            <li>
                    ...
                    <div class="footer-item">
                        ...
                        <ul class="personal-info">
                            <li>
                                ...
                                <?php echo e($sitedetails->address); ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-5">
                    ...
                    <ul class="social-list">
                        <?php if($sitedetails->instagram): ?>
                            <li><a href="<?php echo e($sitedetails->instagram); ?>"><i class="fa-brands fa-instagram"></i></a></li>
                        <?php endif; ?>
                        <?php if($sitedetails->facebook): ?>
                            <li><a href="<?php echo e($sitedetails->facebook); ?>"><i class="fa-brands fa-facebook-f"></i></a></li>
                        <?php endif; ?>
                        <?php if($sitedetails->twitter): ?>
                            <li><a href="<?php echo e($sitedetails->twitter); ?>"><i class="fa-brands fa-x-twitter"></i></a></li>
                        <?php endif; ?>
                        <!-- WhatsApp and Phone might need actual URLs -->
                        <li><a href="https://wa.me/<?php echo e($sitedetails->whatsapp); ?>" target="_blank"><i
                                    class="fa-brands fa-whatsapp"></i></a></li>
                        <!--    <li><a href="tel:<?php echo e($sitedetails->phone_number); ?>"><i class="fa-solid fa-phone"></i></a></li>-->
                    </ul>
...
<script src="<?php echo e(asset('frontend/js/bootstrap-submenu.js')); ?>"></script>
<script src="<?php echo e(asset('frontend/js/jquery.mb.YTPlayer.js')); ?>"></script>
...
<script src="<?php echo e(asset('frontend/js/jquery.filterizr.js')); ?>"></script>
...
<script src="<?php echo e(asset('frontend/js/sidebar.js')); ?>"></script>
...
<?php /**PATH /var/www/demo82_color_usr/data/www/demo82.colormoon.in/rockdale/resources/views/frontend/layouts/footer.blade.php ENDPATH**/ ?>