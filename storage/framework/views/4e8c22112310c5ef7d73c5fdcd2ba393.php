...
<style>
    ...
    <div class="sub-banner" 
         style="background : url('<?php echo e(asset('admin/siteImage/' . $sitesettings->about_breadcome_image)); ?>'); background-size :cover; background-position:center">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12 wow fadeInLeft delay-04s">
                    <div class="about-img-section">
                        <div class="image-box">
                            <div class="image-1"><img src="<?php echo e(asset('admin/aboutImages/' . $about->image)); ?>"
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="main-title mb-3 text-center" data-aos="fade-up" data-aos-duration="1500">
                    <h2><?php echo e($about->testimonials_word); ?> <span><?php echo e($about->testimonials_heading); ?></span></h2>
                    <p><?php echo e($about->testimonials_short_description); ?></p>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="main-title" data-aos="fade-up" data-aos-duration="1500">
                            <h2><?php echo e($about->facilties_word); ?> <span><?php echo e($about->facilties_heading); ?></span></h2>
                            <p><?php echo e($about->facilties_short_description); ?></p>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="services-box-2 d-flex aos-init aos-animate" data-aos="fade-up"
                                ...
                                <div class="fac-icon services-box-div">
                                    <img src="<?php echo e(asset('admin/facilityImages/' . $data->icon)); ?>">
                                </div>
                                <div class="contant">
