    ...
    <div class="col-12">
        <div class="card-group box-margin">
            <div class="card">
                        ...
                        <div class="page-title-box">
                            <div class="row">
                                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 mt-3">
                                    <h5 style="margin-left: 19px;">Room Add</h5>
                                </div>
                                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12" style="margin-left: -19px;">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="<?php echo e(route('room-images.index')); ?>">Room Images</a>
                                            </li>
                ...
                <form method="POST" action="<?php echo e(route('room-images.store')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="frequencySelect" name="rooms_id" class="form-control choices-single">
                                        ...
                                        <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categ): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($categ->id); ?>"
                                                <?php echo e(old('rooms_id') == $categ->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/demo82_color_usr/data/www/demo82.colormoon.in/rockdale/resources/views/admin/room_images/add.blade.php ENDPATH**/ ?>