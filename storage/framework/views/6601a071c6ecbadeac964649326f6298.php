                        ...
                        <div class="page-title-box">
                            <div class="row">
                                ...
                                <div class="col-lg-12 mt-3 ml-5 d-flex justify-content-left">
                                    <a href="<?php echo e(route('mobile-slider.create')); ?>" class="btn btn-primary"><i class="fa fa-plus mr-1"></i>Add New</a>
                                </div>
                            </div>
                                ...
                                <?php $__currentLoopData = $slider; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-center">
                                            <a href="<?php echo e(route('mobile-slider.edit', $data->id)); ?>" class="btn btn-success"><i class="fa fa-pencil  mr-1"></i>Edit</a>
                                            <form method="POST" action="<?php echo e(route('mobile-slider.destroy', $data->id)); ?>" class="delete-form ml-2">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/demo82_color_usr/data/www/demo82.colormoon.in/rockdale/resources/views/admin/mobile_silder/index.blade.php ENDPATH**/ ?>