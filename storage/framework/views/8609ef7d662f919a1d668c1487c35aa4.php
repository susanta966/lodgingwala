                    ...
                    <div class="page-title-box">
                        <div class="row">
                            ...
                            <div class="col-lg-12 mt-3 ml-5 d-flex justify-content-left">
                                <a href="<?php echo e(route('rooms.create')); ?>" class="btn btn-primary"><i
                    ...
                    <table id="datatable" class="table table-striped iq-table1" data-toggle="data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div id="sortable-images-<?php echo e($room->id); ?>" class="image-container"
                                        ...
                                        <div class="image-card" data-image-index="<?php echo e($image['index']); ?>"
                                            ...
                                            <a href="<?php echo e(asset('admin/roomImages/' . $image['path'])); ?>"
                                               target="_blank">
                                                <img src="<?php echo e(asset('admin/roomImages/' . $image['path'])); ?>"
                                                     alt="Image">
                                            </a>
                                            <form method="POST" action="<?php echo e(route('rooms.destroyImage', ['id' => $room->id, 'index' => $image['index']])); ?>" class="delete-image-form">
                                                <?php echo csrf_field(); ?>
                                ...
                                <td><?php echo e($room->status == 1 ? 'Active' : 'Inactive'); ?></td>
                                <td><?php echo e($room->priority); ?></td>
                                <td>
                                    <div class="action-buttons">
                                        <a href="<?php echo e(route('rooms.edit', $room->id)); ?>" class="btn btn-success">
                                            <i class="fa fa-pencil"></i> Edit
                                        </a>
                                        <form method="POST" action="<?php echo e(route('rooms.destroy', $room->id)); ?>"
                                              class="delete-form">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/demo82_color_usr/data/www/demo82.colormoon.in/rockdale/resources/views/admin/room/index.blade.php ENDPATH**/ ?>