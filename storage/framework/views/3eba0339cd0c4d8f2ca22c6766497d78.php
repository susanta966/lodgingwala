                        ...
                        <div class="page-title-box">
                            <div class="row">
                                ...
                                <div class="col-lg-12 mt-3 ml-5 d-flex justify-content-left">
                                    <a href="<?php echo e(route('blogs.create')); ?>" class="btn btn-primary"><i
                            ...
                            <tbody>
                                <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div id="sortable-images-<?php echo e($blog->id); ?>" class="image-container"
                                                ...
                                                <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="image-card" data-image-index="<?php echo e($image['index']); ?>"
                                                        ...
                                                        <form method="POST"
                                                            action="<?php echo e(route('blogs.imagedestroy', ['id' => $blog->id, 'index' => $image['index']])); ?>"
                                            ...
                                            <button class="save-priority-btn btn-primary mt-2" data-blog-id="<?php echo e($blog->id); ?>">Save
                                                Priority</button>
                                        </td>
                                        <td><?php echo e($blog->status == 1 ? 'Active' : 'Inactive'); ?></td>
                                        <td><?php echo e($blog->priority); ?></td>
                                        <td>
                                            <div class="action-buttons">
                                                <a href="<?php echo e(route('blogs.edit', $blog->id)); ?>" class="btn btn-success">
                                                    <i class="fa fa-pencil"></i> Edit
                                                </a>
                                                <form method="POST" action="<?php echo e(route('blogs.destroy', $blog->id)); ?>" class="delete-form">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.querySelectorAll(".save-priority-btn").forEach(button => {
                button.addEventListener("click", function() {
                    ...
                    fetch("<?php echo e(route('blogs.updateImagePriority', ':id')); ?>".replace(':id', blogId), {
                            method: "POST",
                            headers: {
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/demo82_color_usr/data/www/demo82.colormoon.in/rockdale/resources/views/admin/blog/index.blade.php ENDPATH**/ ?>