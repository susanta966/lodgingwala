    ...
    <div class="col-12">
        <div class="card-group box-margin">
            <div class="card">
                                ...
                                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12" style="margin-left: -19px;">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="{{ route('room-images.index') }}">Room Images</a>
                                            </li>
                ...
                <form method="POST" action="{{ route('room-images.store') }}" enctype="multipart/form-data">
                    @csrf
                                    ...
                                    <select id="frequencySelect" name="rooms_id" class="form-control choices-single">
                                        ...
                                        @foreach ($rooms as $categ)
                                            <option value="{{ $categ->id }}"
                                                {{ old('rooms_id') == $categ->id ? 'selected' : '' }}>
                                                {{ $categ->name }}
                                            </option>
                                        @endforeach
                                    </select>
