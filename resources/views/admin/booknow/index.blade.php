                        ...
                        <div class="page-title-box">
                            <div class="row">
                                ...
                                <div class="col-lg-12 mt-3 ml-5 d-flex justify-content-left">
                                    <a href="{{ route('booknow.create') }}" class="btn btn-primary"><i
                            ...
                            <tbody>
                                ...
                                @foreach ($booknows as $booknow)
                                    <tr>
                                        <td>{{ $serial++ }}</td>
                                        <td>{{ $booknow->title }}</td>
                                        <td>{{ $booknow->status == 1 ? 'Active' : 'Inactive' }}</td>
                                        <td>{{ $booknow->priority }}</td>
                                        <td class="d-flex justify-content-center">
                                            <div class="action-buttons">
                                                <a href="{{ route('booknow.edit', $booknow->id) }}"
                                                    class="btn btn-success"><i class="fa fa-pencil mr-1"></i>Edit</a>
                                                <form method="POST" action="{{ route('booknow.destroy', $booknow->id) }}"
                                                    class="delete-form">
                                                    @csrf
                                                    @method('DELETE')
